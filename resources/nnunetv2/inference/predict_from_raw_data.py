...
from resources.nnunetv2.inference.export_prediction import export_prediction_from_logits, \
...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        trainer_class = recursive_find_python_class(join(os.path.abspath(os.getcwd()), "resources/nnunetv2/training", "nnUNetTrainer"),
                                                trainer_name, 'resources.nnunetv2.training.nnUNetTrainer')
